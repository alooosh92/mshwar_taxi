...
class HosttingTaxi {
  ...
  static const String host = "http://northtaxi.srv451438.hstgr.cloud";
  //  "https://62.72.22.182:8090/preview/srv451438.hstgr.cloud/";
  static const String websocket = "ws://srv451438.hstgr.cloud:8080/app/myKey2";
  //"ws://srv451438.hstgr.cloud:8443/app/myKey";
  ...
  //img
  static Uri image(String name, String state) =>
      Uri.parse('$host/storage/company_$name/${name}_$state.png');
  //API
  ...
  static Uri getDriverTrip = Uri.parse("$api/GetTrip");
