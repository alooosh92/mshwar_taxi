                              ...
                              Get.dialog(AlertDialog(
                                ...
                                content: Column(
                                    ...
                                    children: [
                                      const Divider(),
                                      const Text(
                                        "ملاحظة: إن اغلاق التطبيق لا يعني إلغاء الرحلة وفي حال عدم الغاء الرحلة من قبلكم سيتم إلغاء الرحلة بشكل تلقائي بعد 120 ثانية من الطلب",
                                        style: FontManager.w600s16cR,
                                      ),
                                      const Divider(),
                                      Text(
