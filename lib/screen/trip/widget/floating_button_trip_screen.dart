          ...
          child: SizedBox(
            child: Row(
              children: [
                ...
                Visibility(
                  visible: !(controller.tripAccsepted ?? true),
                  child: InkWell(
                    onTap: () => Get.dialog(const DeleteTrip()),
                    child: Image.asset(
                      "lib/asset/images/delete.gif",
                      height: 48,
                    ),
                  ),
                )
        ...
        ElevatedButton(
          onPressed: () {
            if (controller.tripUserAdd != null) {
              controller.deleteTrip(controller.tripUserAdd!.id);
              controller.changetripaccsepted(null);
              Get.back();
            }
          },
